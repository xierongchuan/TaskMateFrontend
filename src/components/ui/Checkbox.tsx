      ...
      >
        <div className="flex items-center h-5">
          <input
            ...
            type="checkbox"
            id={checkboxId}
            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded disabled:opacity-50 disabled:cursor-not-allowed dark:bg-gray-700 dark:border-gray-600"
            {...props}
          />
        </div>
        {(label || description) && (
